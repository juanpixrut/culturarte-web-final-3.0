...
public class ictrl {
    ...
    public static final class Fotos {
        ...
        /**
         * Carga la imagen {baseName}.{png|jpg|jpeg} desde 'carpeta', la escala
         * al "box" y la devuelve como PNG en bytes.
         */
        ...
        private static BufferedImage escalar(BufferedImage src, int boxW, int boxH, boolean permitirUpscale) {
            ...
            if (!permitirUpscale) {
                scale = Math.min(scale, 1.0); // evita agrandar imágenes chicas
            }
